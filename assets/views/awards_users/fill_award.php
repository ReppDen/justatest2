...
<fieldset>
    ...
    <input type="hidden" name="o7_2_name" value="число аспирантов/докторантов, защитившихся в отчетный период"/>
...
function third_stage() {
    echo '<fieldset>
        ...
        уровней)</label>
        <input type="hidden" name="o1_1_name" value="Признание профессиональным сообществом"/>

<script>
    $(document).ready(function() {
        $("#set_date").click(function() {
            ...
            location.href="/uvp/list_payment/" + $("#year").val() + "/" + params;
        });
...
<table class="table">
    <tr>
        ...
        <td>
            <a href="/uvp/list_payment/<?php echo $year;?>/?sort=type&dir=<?php echo getDir("type");?>" class="sorter">Тип расчета<?php echo dirText("type");?></a>
        </td>
        <td>
            <a href="/uvp/list_payment/<?php echo $year;?>/?sort=date&dir=<?php echo getDir("date");?>" class="sorter">Дата<?php echo dirText("date");?></a>
        </td>
        <td>
           <a href="/uvp/list_payment/<?php echo $year;?>/?sort=sum&dir=<?php echo getDir("sum");?>" class="sorter">Баллы<?php echo dirText("sum");?></a>
        </td>
        <td>
            Детали
        </td>

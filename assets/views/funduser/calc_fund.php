<h3>Расчет фонда стимулурующих выплат для преподавателей</h3>
        ...
        $("#next_btn").click(function() {
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res == 0) {
                        console.log("вопрос");
                        if (confirm("Расчет для факультета, года и этапа еще не существует расчетов баллов, расчет выплат не возможен. \n Перейти на страницу расчета баллов?")) {

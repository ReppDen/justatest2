<fieldset>
    <legend>Расчет выплат преподавателям за <?php echo $year; ?> год.</legend>
    <table>
        <tr>
            <td>
...
<table class="table table_for_years">
    <tr class="title">
        ...
        <td >
            <a href="/funduser/list_fund/<?php echo $year;?>/<?php echo $stage?>/<?php echo $faculty->id;?>?sort=fio&dir=<?php echo getDir("fio");?>" class="sorter">ФИО<?php echo dirText("fio");?></a>
        </td>
        <td >
            <a href="/funduser/list_fund/<?php echo $year;?>/<?php echo $stage?>/<?php echo $faculty->id;?>?sort=money&dir=<?php echo getDir("money");?>" class="sorter">Год <?php echo $year; echo dirText("money");?></a>
        </td>
    </tr>
    <?php
    $i = 0;
...
<script>
    $(document).ready(function() {
        $("#set_filter").click(function() {
            ...
            location.href="/funduser/list_fund/" + $("#year").val() + "/" + $("#stage").val() + "/" + $("#faculty").val() + "/"+ params;
        });
